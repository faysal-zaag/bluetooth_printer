import 'dart:io';
import 'package:bluetooth_printer/Helper/Constant.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Printer Setting', style: TextStyle(color: WHITE)),
        actions: [
          PopupMenuButton(
            elevation: 3.2,
            onCanceled: () {
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(_msj, style: const TextStyle(color: Colors.black87),),
              Row(
                children: [
                  Text(
                    "Type print",
                  ...
                  ElevatedButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(_progress ? _msjprogress : "Search", style: const TextStyle(color: WHITE)),
                      ],
                    ),
                  ),
                  ElevatedButton(
                    ...
                    child: const Text("Disconnect", style: TextStyle(color: WHITE)),
                  ),
                ],
              ),
              ...
              Expanded(
                child: Column(
                  children: [
                    ...printers.map((printer) => GestureDetector(
                      onTap: (){
                        String mac = printer.macAdress;
                        connect(mac);
                      },
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.print_sharp, color: PRIMARY_COLOR_LIGHT,),
                                // Image.asset("assets/images/pos_printer.png", scale: 3,),
                                const SizedBox(width: 5,),
                                Text(printer.name, style: Theme.of(context).textTheme.titleLarge,),
                              ],
                            ),
                            if(printer.macAdress == connectedPrinterMac)
                              Row(
                                children: [
                                  Text('Connected', style: Theme.of(context).textTheme.headlineSmall,),
                                  const Icon(Icons.check_circle, color: PRIMARY_COLOR_LIGHT,),
                                ],
                              )
                          ],
                        ),
